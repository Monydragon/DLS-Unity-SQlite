...
namespace DLS.SQLiteUnity
{
    ...
    /// <summary>
    /// This class is Responsible for handling SQLite3 DLL execution methods and SQLite3 related operations.
    /// </summary>
    public static class SQLite3_DLL_Handler
    {
        ...
        #endregion //END Region Local Enums
        ...
        {
            return Marshal.PtrToStringUni (SQLite3_DLL_Handler.ColumnText16 (stmt, index));
        }
